...
interface BrandUserMenuDropdownProps {
...
export const BrandUserMenuDropdown: React.FC<BrandUserMenuDropdownProps> = ({
    user,
    collapsed,
    onNavigate,
    onLogout,
            ...
            {isOpen && !collapsed && (
                ...
                >
                    <NavLink
                        ...
                        role="menuitem"
                        className={({ isActive }) =>
                            `flex items-center gap-2 px-3 py-2.5 text-sm transition-colors ${isActive
...
export default BrandUserMenuDropdown;
