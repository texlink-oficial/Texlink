...
const OrderDetailsPage: React.FC = () => {
    ...
    const isFinalized = ['FINALIZADO', 'PARCIALMENTE_APROVADO', 'REPROVADO', 'CANCELADO'].includes(order.status);
