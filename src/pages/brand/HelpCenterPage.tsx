...
import {
    ArrowLeft, HelpCircle, Plus, Search, AlertCircle,
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <Link to="/brand" className="text-gray-400 hover:text-gray-600 dark:hover:text-white transition-colors">
            ...
            {showCreateModal && (
                <CreateTicketModal
                    ...
                    onCreated={(ticket) => {
                        ...
                        navigate(`/brand/suporte/${ticket.id}`);
                    }}
                />
            )}
        </div>
