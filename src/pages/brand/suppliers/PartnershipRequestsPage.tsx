...
import { Send, Clock, CheckCircle, XCircle, Ban } from 'lucide-react';
...
type TabStatus = 'PENDING' | 'ACCEPTED' | 'REJECTED' | 'CANCELLED' | 'all';
...
export const BrandPartnershipRequestsPage: React.FC = () => {
  ...
  const handleCancel = async (request: PartnershipRequest) => {
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">
            Gerencie suas solicitações enviadas para fornecedores
          </p>
        </div>
        <Button
          variant="primary"
          onClick={() => navigate('/marca/fornecedores/adicionar')}
          className="gap-2"
        >
...
export default BrandPartnershipRequestsPage;
