...
import {
    ...
    RefreshCw, User, Headphones, AlertTriangle,
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <Link to="/brand/suporte" className="text-gray-400 hover:text-gray-600 dark:hover:text-white transition-colors">
