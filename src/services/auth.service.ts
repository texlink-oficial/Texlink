...
// SEC-F001 + SEC-REM-004: Both tokens live in memory only.
// Access token is short-lived (1h). Refresh token is also memory-only
// so it cannot be exfiltrated via XSS. Trade-off: page refresh logs users out.
