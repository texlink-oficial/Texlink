export enum OrderStatus {
  NEW = 'LANCADO_PELA_MARCA',
  NEGOTIATING = 'EM_NEGOCIACAO',
  ACCEPTED = 'ACEITO_PELA_FACCAO',
  PREPARING_BRAND = 'EM_PREPARACAO_SAIDA_MARCA',
  TRANSIT_TO_SUPPLIER = 'EM_TRANSITO_PARA_FACCAO',
  RECEIVED_SUPPLIER = 'EM_PREPARACAO_ENTRADA_FACCAO',
  PRODUCTION_QUEUE = 'FILA_DE_PRODUCAO',
  PRODUCTION = 'EM_PRODUCAO',
  READY_SEND = 'PRONTO',
  TRANSIT_TO_BRAND = 'EM_TRANSITO_PARA_MARCA',
  IN_REVIEW = 'EM_REVISAO',
  PARTIALLY_APPROVED = 'PARCIALMENTE_APROVADO',
  DISAPPROVED = 'REPROVADO',
  AWAITING_REWORK = 'AGUARDANDO_RETRABALHO',
  PAYMENT_PROCESS = 'EM_PROCESSO_PAGAMENTO',
  FINALIZED = 'FINALIZADO',
  CANCELLED = 'CANCELADO',
  REJECTED = 'RECUSADO_PELA_FACCAO',
  AVAILABLE_FOR_OTHERS = 'DISPONIVEL_PARA_OUTRAS'
}
