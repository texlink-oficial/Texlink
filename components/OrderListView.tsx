...
export const OrderListView: React.FC<OrderListViewProps> = ({ orders, onOrderClick, onBulkAction }) => {
  ...
  const getStatusBadge = (status: OrderStatus) => {
    switch (status) {
      ...
      case OrderStatus.NEGOTIATION: return 'bg-purple-100 text-purple-700 border-purple-200 dark:bg-purple-900/30 dark:text-purple-300 dark:border-purple-800';
      case OrderStatus.WAITING: return 'bg-amber-100 text-amber-700 border-amber-200 dark:bg-amber-900/30 dark:text-amber-300 dark:border-amber-800';
  ...
  const getStatusLabel = (status: OrderStatus) => {
    switch (status) {
        ...
        case OrderStatus.NEGOTIATION: return 'Negociação';
              ...
              return (
                ...
                >
                  ...
                  <td className="px-6 py-4">
                    ...
                    {order.waitingReason && order.status === OrderStatus.WAITING && (
