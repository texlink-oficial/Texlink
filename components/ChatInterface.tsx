...
import { X, Send, Paperclip, MoreVertical, CheckCheck, HandCoins, ArrowRight, DollarSign, Calendar, Package, ChevronDown } from 'lucide-react';
                ...
                {msg.type === 'proposal' && msg.proposal && (
                    <div className="min-w-[250px]">
                        <div className={`px-4 py-2 text-xs font-bold uppercase tracking-wider flex items-center gap-2 border-b border-white/20
                            ...
                            <HandCoins className="h-4 w-4" /> Proposta de Negociação
                        </div>
                ...
                <div className="p-4 space-y-4">
                    <div className="flex justify-between items-center mb-2">
                        <h4 className="font-bold text-gray-800 dark:text-white flex items-center gap-2">
                            <HandCoins className="h-5 w-5 text-brand-500" /> Nova Proposta
                        </h4>
